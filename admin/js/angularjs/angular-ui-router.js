    ...
    compile: function (tElement, tAttrs, $transclude) {
      return function (scope, $element, attrs) {
        var previousEl, currentEl, currentScope, latestLocals,
            loadedEl      = [],     // added by Hanbiro Dev Team. 2014.04.20
        ...
        */
        ...
        // modified by Hanbiro Dev Team. 2014.04.20
        function cleanupLastView() {
          if (previousEl) {           
            previousEl.remove();
            previousEl = null;
          ...
          if (currentEl) {
              ...
              if(currentEl.prev().children().length == 0) {
                  renderer.leave(currentEl.prev(), function() {
                      previousEl = null;
                   });                
              }           
        ...
        function updateView(firstTime) {
          ...
          */
          // modified by Hanbiro Dev Team. 2014.04.20          
          if (!firstTime && (previousLocals === latestLocals || loadedEl.hasOwnProperty(name))) return; // nothing to do
          ...
          loadedEl[name] = true;        // added by Hanbiro Dev Team. 2014.04.20
