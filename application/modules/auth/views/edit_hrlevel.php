<div class="container-fluid">
      ...
      <div class="jumbotron">
        <h3><?php echo $this->lang->line('level_info_update'); ?></h3>
        <a href="<?php echo base_url(); ?>auth/hrlevel"><button type="button" class="btn btn-default btn-lg">  <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $this->lang->line('back'); ?></button></a>
        <div class="form-edit-hr-level" >
              ...
              <tr>
                <td>
                  <div class="form-group">
                      ...
                      <input id="levelid" required type="text" class="form-control" placeholder="<?php echo  $this->lang->line('level_id') ; ?>" value="<?php echo $item['level_id']; ?>">
                    </div>
                  </td>
                <td>
                  <div class="form-group">
                    <label><?php echo  $this->lang->line('level_name') ; ?></label>
                    <input id="name" required type="text" class="form-control" placeholder="<?php echo  $this->lang->line('level_name') ; ?>" value="<?php echo $item['name']; ?>">
                  </div>
                </td>
              </tr>
            </table>
            ...
            <button class="btn btn-primary submit-hr-level"><?php echo $this->lang->line('update'); ?></button>
        </div>
      </div>
</div>
